...
$("#upload-form").on("submit", function (e) {
  ...
  audio_file = "skip";
  authors = $("#p_authors").val().split();
  uploadPodcast(p_fname, p_lname, p_email, authors,article_title, journal, publish_date, DOI, keywords, audio_file)
  
});

function uploadPodcast(fname, lname, email, authors, article_title, journal, publish_date, DOI, keywords, audio_file) {
